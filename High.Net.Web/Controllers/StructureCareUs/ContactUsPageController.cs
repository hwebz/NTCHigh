...
namespace High.Net.Web.Controllers.StructureCareUs
{
    ...
    public class ContactUsPageController : StructureCareUsController<ContactUsPage>
    {
        public ActionResult Index(ContactUsPage currentPage)
        {
            ...
            return View("~/Views/StructureCareUs/Pages/ContactUsPage/Index.cshtml", model);
        ...
        public ActionResult Index(ContactUsPage currentPage, ContactUsForm ContactUsForm)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                string EmailConfimationMailBody = string.Format(Convert.ToString(currentPage.EmailConfirmationMessage), homePage.Name, homePage.PhoneNumber, homePage.EmailID);
