...
namespace High.Net.Web.Controllers.HighConcrete
{
    ...
    public class ContactUsPageController : PageController<ContactUsPage>
    {
        public ActionResult Index(ContactUsPage currentPage)
        {
            ...
            return View("~/Views/HighConcrete/Pages/ContactUsPage/Index.cshtml", model);
        ...
        public ActionResult Index(ContactUsPage currentPage, ContactUsForm ContactUsForm)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                string EmailConfimationMailBody = string.Format(Convert.ToString(currentPage.EmailConfirmationMessage), homePage.Name, homePage.Contact, homePage.Email);
                ...
                model.ContactUsForm.ThankYouMessageText = String.Format(Convert.ToString(currentPage.ThankYouMessage), homePage.Name, homePage.Email);
            }
