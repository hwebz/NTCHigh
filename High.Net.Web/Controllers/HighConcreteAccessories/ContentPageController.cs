...
{
    public class ContentPageController : HighConcreteAccessoriesController<ContentPage>
    {
        public ActionResult Index(ContentPage currentPage)
        {
            var model = PageViewModel.Create(currentPage);
            return View("~/Views/HighConcreteAccessories/Pages/ContentPage/Index.cshtml",model);
        }
    }
}