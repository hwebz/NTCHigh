...
namespace High.Net.Web.Controllers.Rollover
{
    ...
    public class ContactUsPageController : PageController<ContactUsPage>
    {
        public ActionResult Index(ContactUsPage currentPage)
        {
            ...
            return View("~/Views/Rollover/Pages/ContactUsPage/Index.cshtml", model);
        }
        ...
        public ActionResult Index(ContactUsPage currentPage, ContactUsForm ContactUsForm)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                string EmailConfimationMailBody = string.Format(Convert.ToString(currentPage.EmailConfirmationMessage), homePage.Name, homePage.PhoneNo, homePage.EmailAddress);
