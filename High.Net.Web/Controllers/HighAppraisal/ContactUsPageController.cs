...
namespace High.Net.Web.Controllers.HighAppraisal
{
    ...
    public class ContactUsPageController : PageController<ContactUsPage>
    {
        public ActionResult Index(ContactUsPage currentPage)
        {
            ...
            return View("~/Views/HighAppraisal/Pages/ContactUsPage/Index.cshtml", model);
        ...
        public ActionResult Index(ContactUsPage currentPage, ContactUsForm ContactUsForm)
        {
            ...
            var homePage = repo.GetAncestors(currentPage.ContentLink).Where(x => x.GetType().BaseType == typeof(HomePage)).FirstOrDefault() as HomePage;
            ...
            if (ModelState.IsValid)
            {
                ...
                string EmailConfimationMailBody = string.Format(Convert.ToString(currentPage.EmailConfirmationMessage), homePage.Name, homePage.PhoneNumber, currentPage.BusinessRecipientsEmail);
                ...
                model.ContactUsForm.ThankYouMessageText = String.Format(Convert.ToString(currentPage.ThankYouMessage), homePage.Name, currentPage.BusinessRecipientsEmail);
            }
