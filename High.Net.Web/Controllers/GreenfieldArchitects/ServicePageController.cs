...
{
    public class ServicePageController : GreenfieldArchitectsController<ServicePage>
    {
        public ActionResult Index(ServicePage currentPage)
        {
            ...
            return View("~/Views/GreenfieldArchitects/Pages/ServicePage/Index.cshtml", model);
        }
    }
}