...
var example = new switchcontent("switchgroup1", "div") //Limit scanning of switch contents to just "div" elements
example.setStatus('', '')
example.setColor('470C15', 'B7325E')
example.setPersist(true)
example.collapsePrevious(true) //Only one content open at any given time
example.init()
