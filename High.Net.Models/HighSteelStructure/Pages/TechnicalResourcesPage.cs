...
{
    [SiteContentType(DisplayName = "Technical Resources Page",
         GroupName = SiteGroups.HSS,
        GUID = "8df38a96-bee5-44e6-890f-8acab78479b9", Description = "", Order = 18080)]    
    [AvailableContentTypes(Availability.Specific, Include = new[] { typeof(ContentPage) })]
    public class TechnicalResourcesPage : HighSteelStructurePageData
    {
        #region Content
