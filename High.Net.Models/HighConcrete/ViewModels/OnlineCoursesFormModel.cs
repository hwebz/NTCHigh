...
{
    public class OnlineCoursesFormModel : PageViewModel<OnlineCoursesFormPage>
    {
        public OnlineCoursesFormModel(OnlineCoursesFormPage currentPage)
            : base(currentPage)
        {
            this._OnlineCoursesForm = new OnlineCoursesForm();
            this._OnlineCoursesForm.CertificateOfCompletionRequired = false;
            this._OnlineCoursesForm.Ismailsendsuccessfully = false;
        }

        public OnlineCoursesForm _OnlineCoursesForm { get; set; }
    }

    public class OnlineCoursesForm
    {
        // contructor to fill all dropdown information 
        public OnlineCoursesForm()
        {
        ...
        #region Online Course Information
        ...
        public bool CertificateOfCompletionRequired { get; set; }
